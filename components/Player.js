...
function Player() {
    ...
    return (
        <div className="h-24 bg-gray-800 bg-opacity-75 text-white grid grid-cols-3 text-sm md:text-base px-2 md:px-8">
            ...
            <div className="flex items-center justify-evenly">
                ...
                {isPlaying ? (
                    <PauseIcon
                        className="w-10 h-10 cursor-pointer hover:scale-125 transition transform duration-100 ease-out text-white"
